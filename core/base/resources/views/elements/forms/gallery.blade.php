...
<div class="gallery-image-box">
    {!! Form::hidden($name, $value ? json_encode($value) : null, ['class' => 'gallery-data form-control']) !!}
    <div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="float-left btn btn-danger delete-gallery-item" href="#">{{ trans('core-base::gallery.delete_photo') }}</button>
