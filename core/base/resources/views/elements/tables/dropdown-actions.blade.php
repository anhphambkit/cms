<span class="dropdown table-actions">
    ...
    <span aria-labelledby="table-actions-{{ $item->id }}" class="dropdown-menu mt-1 dropdown-menu-right">
        <a href="{{ route($edit, $item->id) }}" class="dropdown-item"><i class="la la-eye"></i> Edit Item</a>
        <a href="javascript:void(0)" class="dropdown-item deleteDialog tip" data-toggle="modal" data-section="{{ route($delete, $item->id) }}"><i class="la la-trash"></i> Delete</a>
