...
class PluginCreateCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->location = config('core-base.cms.plugin_path') . '/' . strtolower($this->plugin);
        ...
        if (!empty($plugin)) {
            ...
            if (!empty($composer)) {
                $composer['autoload']['psr-4']['Plugins\\' . studly_case($this->plugin) . '\\'] = 'plugins/' . strtolower($this->plugin) . '/src';
