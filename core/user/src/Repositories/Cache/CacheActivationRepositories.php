...
class CacheActivationRepositories extends CacheAbstractDecorator implements ActivationRepositories
{
    /**
     ...
     * @author TrinhLe
     */
    public function __construct(ActivationRepositories $repository)
    {
        parent::__construct();
