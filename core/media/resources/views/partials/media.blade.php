...
<link href="{{ asset('frontend/core/media/assets/css/media.css?v=' . time()) }}" rel="stylesheet" type="text/css" />
<script src="{{ asset('frontend/core/media/assets/js/integrate.js?v=' . time()) }}"></script>
