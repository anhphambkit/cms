...
@section('content')
    {!! Form::open(['route' => ['admin.product.category.edit', $infoCategory->id]]) !!}
        @php do_action(BASE_FILTER_BEFORE_RENDER_FORM, PRODUCT_MODULE_SCREEN_NAME, request(), $infoCategory) @endphp
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="from-actions-bottom-right">{{ trans('plugins-product::category.edit') }}</h4>
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('name')) has-error @endif">
                                        ...
                                        {!! Form::text('name', $infoCategory->name, ['class' => 'form-control', 'id' => 'name', 'placeholder' => trans('core-base::forms.name_placeholder'), 'data-counter' => 120]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 mb-2 @if ($errors->has('parent_id')) has-error @endif">
                                        ...
                                        {!! Form::select('parent_id', $categories, $infoCategory->parent_id, ['class' => 'select2-placeholder-multiple form-control category-list', "id" => "select-category-list" ]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('description')) has-error @endif">
                                        ...
                                        {!! render_editor('description', $infoCategory->description, true) !!}
            ...
            <div class="col-md-3 right-sidebar">
                ...
                @include('core-base::elements.forms.status', ['selected' => $infoCategory->status])
                @php do_action(BASE_ACTION_META_BOXES, PRODUCT_MODULE_SCREEN_NAME, 'top', $infoCategory) @endphp
                @php do_action(BASE_ACTION_META_BOXES, PRODUCT_MODULE_SCREEN_NAME, 'side', $infoCategory) @endphp
            </div>
        </div>
    {!! Form::close() !!}
@stop