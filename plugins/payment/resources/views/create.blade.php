...
@section('content')
    {!! Form::open(['route' => 'admin.payment.create']) !!}
        @php do_action(BASE_FILTER_BEFORE_RENDER_FORM, PAYMENT_MODULE_SCREEN_NAME, request(), null) @endphp
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="from-actions-bottom-right">{{ trans('plugins-payment::payment.create') }}</h4>
            ...
            <div class="col-md-3 right-sidebar">
                ...
                @php do_action(BASE_ACTION_META_BOXES, PAYMENT_MODULE_SCREEN_NAME, 'top') @endphp
                @php do_action(BASE_ACTION_META_BOXES, PAYMENT_MODULE_SCREEN_NAME, 'side') @endphp
            </div>
        </div>
    {!! Form::close() !!}
@stop