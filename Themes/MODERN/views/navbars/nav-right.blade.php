<li class="dropdown dropdown-user nav-item">
    <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1">Hello,<span class="user-name text-bold-700">{{ acl_get_current_user()->getFullName() }}</span></span><span class="avatar avatar-online"><img src="{{ acl_get_current_user()->getProfileImage() }}" alt="avatar"><i></i></span>
    </a>
