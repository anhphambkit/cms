<li class="dropdown dropdown-user nav-item">
    <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1">Hello,<span class="user-name text-bold-700">{{ auth()->user()->getFullName() }}</span></span><span class="avatar avatar-online"><img src="{{ auth()->user()->getProfileImage() }}" alt="avatar"><i></i></span>
    </a>
